...
class $AssetsIconsGen {
  ...
  SvgGenImage get addItem => const SvgGenImage('assets/icons/add_item.svg');

  /// List of all assets
  List<SvgGenImage> get values => [addItem];
}
...
class $AssetsLottieGen {
  ...
  /// List of all assets
  List<LottieGenImage> get values => [empty, emptyTwo, loading];
}
